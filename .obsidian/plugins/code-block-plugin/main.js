  ...
  "node_modules/highlight.js/lib/languages/cpp.js"(exports, module2) {
    function cpp(hljs2) {
      ...
      const FUNCTION_DISPATCH = {
        ...
        begin: regex.concat(/\b/, /(?!decltype)/, /(?!if)/, /(?!for)/, /(?!switch)/, /(?!while)/, hljs2.IDENT_RE, regex.lookahead(/(<[^<>]+>|)\s*\(/))
      };
      const EXPRESSION_CONTAINS = [
        FUNCTION_DISPATCH,
        PREPROCESSOR,
        ...
        contains: [
          {
            ...
            contains: [hljs2.inherit(STRING, { className: "string" })]
          }
        ]
      };
      const KOTLIN_NUMBER_MODE = NUMERIC;
      const KOTLIN_NESTED_COMMENT = hljs2.COMMENT("/\\*", "\\*/", { contains: [hljs2.C_BLOCK_COMMENT_MODE] });
...
var require_less = __commonJS({
  "node_modules/highlight.js/lib/languages/less.js"(exports, module2) {
    ...
    function less(hljs2) {
      ...
      VALUE_MODES.push(hljs2.C_LINE_COMMENT_MODE, hljs2.C_BLOCK_COMMENT_MODE, STRING_MODE("'"), STRING_MODE('"'), modes.CSS_NUMBER_MODE, {
        begin: "(url|data-uri)\\(",
        starts: {
          className: "string",
          end: "[\\)\\n]",
  ...
  "node_modules/highlight.js/lib/languages/rust.js"(exports, module2) {
    function rust(hljs2) {
      ...
      const FUNCTION_INVOKE = {
        ...
        relevance: 0,
        begin: regex.concat(/\b/, /(?!let\b)/, hljs2.IDENT_RE, regex.lookahead(/\s*\(/))
      };
